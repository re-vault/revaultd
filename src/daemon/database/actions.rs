...
mod test {
    ...
    use crate::utils::test_utils::dummy_revaultd;
    use revault_tx::{
    ...
    const REVAULT_DATADIR: &str = "actions_datadir";
    ...
    fn test_db_creation() {
        let mut revaultd = dummy_revaultd(REVAULT_DATADIR, UserRole::ManagerStakeholder);
