...
mod tests {
    ...
    use crate::utils::test_utils::dummy_rpcutil;
    ...
    const REVAULT_DATADIR: &str = "server_datadir";
    ...
    fn simple_write_recv() {
        let rpcutils = dummy_rpcutil(REVAULT_DATADIR, UserRole::ManagerStakeholder);
